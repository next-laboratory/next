...
- 基于 Psr7 的 max/http-message
- 基于 Psr11 的 max/container
- 基于 Psr14 的 max/event
- 基于 Psr15 的 http-Server
- 基于 Psr16 的 max/cache，支持 File,Memcached,Redis,APC [可扩展]
- 符合 Psr7 规范的 max/routing 路由组件
- 数据库 max/database 组件，支持连接池
- Session max/session
- Blade视图组件 max/view
- 验证器: max/validator
- 切面编程 max/aop
